...
function (e) {
    e("[data-modal-id]").each((function () {
        var t = e(this),
            a = e(this).attr("data-modal-id");
        "" !== a && e("#" + a).each((function () {
            var a = e(this),
                i = e(this)[0].hasAttribute("data-modal-backdrop"),
                s = e(this).attr("data-modal-backdrop"),
                r = e(this)[0].hasAttribute("data-show-on"),
                n = e(this).attr("data-show-on"),
                o = e(this)[0].hasAttribute("data-modal-delay"),
                l = e(this).attr("data-modal-delay"),
                d = e.isNumeric(l),
                c = e(this)[0].hasAttribute("data-modal-duration"),
                p = e(this).attr("data-modal-duration"),
                u = e.isNumeric(p);
            !0 === c && !0 === u && e(a).on("shown.bs.modal", (function () {
                setTimeout((function () {
                    e(a).modal("hide")
                }), p)
            })), !0 === r ? "load" === n ? (e(t).css({
                display: "none"
            }), !0 === o && !0 === d ? e(window).on("load", (function () {
                setTimeout((function () {
                    !0 === i ? "static" === s ? e(a).modal({
                        backdrop: "static"
                    }) : "false" === s ? e(a).modal({
                        backdrop: !1
                    }) : e(a).modal({
                ...
                display: "none"
            }), !0 === o && !0 === d ? e(document).one("mouseleave", (function () {
                setTimeout((function () {
                    !0 === i ? "static" === s ? e(a).modal({
                        backdrop: "static"
                    }) : "false" === s ? e(a).modal({
            ...
            }))) : "hover" === n ? !0 === o && !0 === d ? e(t).hover((function () {
                setTimeout((function () {
                    !0 === i ? "static" === s ? e(a).modal({
                        backdrop: "static"
                    }) : "false" === s ? e(a).modal({
    ...
    })), e(".modal.bs4_modal").on("show.bs.modal", (function () {
        e(this).find(".bs4-carousel").each((function () {
            var t = e(this).attr("data-duration");
            e.fn.carousel.Constructor.TRANSITION_DURATION = t, e(this).find(".carousel-item").each((function () {
                e(this).css({
    ...
    var t = e(".carousel").hasClass("swipe-y"),
        a = e(".carousel").hasClass("swipe-x");
    !0 === t && e(".swipe-y .carousel-inner").swipe({
        swipeUp: function (t, a, i, s, r) {
        ...
        threshold: 0
    }), !0 === a && e(".swipe-x .carousel-inner").swipe({
        swipeLeft: function (t, a, i, s, r) {
            e(this).parent().carousel("next")
        },
        swipeRight: function (t, a, i, s, r) {
            e(this).parent().carousel("prev")
        },
        threshold: 0
    });
    var i = e(".carousel").hasClass("thumb-scroll-x"),
        s = e(".carousel").hasClass("thumb-scroll-y");
    if (!0 === i && e(".thumb-scroll-x").each((function () {
            var t = 0;
            e(this).on("slide.bs.carousel", (function () {
                var a = -1 * e(this).find(".carousel-indicators li:first-child").position().left + e(this).find(".carousel-indicators li:last-child").position().left + e(this).find(".carousel-indicators li:last-child").width(),
                    i = e(this).find(".carousel-indicators li.active").position().left + e(this).find(".carousel-indicators li.active").width() / 1.2 + t - e(this).find(".carousel-indicators").width() / 1.2;
                i < 0 && (i = 0), i > a - e(this).find(".carousel-indicators").width() && (i = a - e(this).find(".carousel-indicators").width()), e(this).find(".carousel-indicators").animate({
                    scrollLeft: i
                }, 800), t = i
            })), e(this).on("slid.bs.carousel", (function () {
                var a = -1 * e(this).find(".carousel-indicators li:first-child").position().left + e(this).find(".carousel-indicators li:last-child").position().left + e(this).find(".carousel-indicators li:last-child").width(),
                    i = e(this).find(".carousel-indicators li.active").position().left + e(this).find(".carousel-indicators li.active").width() / 1.2 + t - e(this).find(".carousel-indicators").width() / 1.2;
                i < 0 && (i = 0), i > a - e(this).find(".carousel-indicators").width() && (i = a - e(this).find(".carousel-indicators").width()), e(this).find(".carousel-indicators").animate({
                    scrollLeft: i
        ...
        var r = 0;
        e(".thumb-scroll-y").each((function () {
            e(this).on("slide.bs.carousel", (function () {
                var t = -1 * e(this).find(".carousel-indicators li:first").position().top + e(this).find(".carousel-indicators li:last").position().top + e(this).find(".carousel-indicators li:last").height(),
                    a = e(this).find(".carousel-indicators li.active").position().top + e(this).find(".carousel-indicators li.active").height() / 1.2 + r - e(this).find(".carousel-indicators").height() / 1.2;
                a < 0 && (a = 0), a > t - e(this).find(".carousel-indicators").height() && (a = t - e(this).find(".carousel-indicators").height()), e(this).find(".carousel-indicators").animate({
                    scrollTop: a
                }, 800), r = a
            })), e(this).on("slid.bs.carousel", (function () {
                var t = -1 * e(this).find(".carousel-indicators li:first").position().top + e(this).find(".carousel-indicators li:last").position().top + e(this).find(".carousel-indicators li:last").height(),
    ...
    e(".bs4-carousel").each((function () {
        var t, a = e(this),
            i = a[0].hasAttribute("data-column");
        if (!0 === i) {
            function s() {
                var t = a.attr("id"),
                    ...
                    d = a.attr("data-m992"),
                    c = a[0].hasAttribute("data-m992"),
                    p = a.attr("data-m768"),
                    u = a[0].hasAttribute("data-m768"),
                    h = a.attr("data-m576"),
                    ...
                    if ("" !== c && c > 0 && c <= r) {
                        if (window.matchMedia(l).matches) {
                            e(s).each((function () {
                                ...
                                for (var a = 1; a < c; a++)(t = t.next()).length || (t = e(this).siblings(":first")), t.children(":first-child").children(":first-child").clone().addClass("cloneditem-" + a + " cloneditems").appendTo(e(this).children(":first-child"))
                            }));
                            var p = 100 / c + "%";
                            e(s).on("slideIsChanging", (function () {
                                a.find(".active.carousel-item-left, .carousel-item-prev").css({
                                    "-webkit-transform": "translateX(-" + p + ")",
                                    transform: "translateX(-" + p + ")",
                                    "-webkit-transform": "-webkit-translate3d(-" + p + ",0,0)",
                        ...
                        var u = "In Slider Id : #" + t;
                        u += "\n", u += "You are assigning the value (" + c + ") to the (data-" + d + ") attribute. Which is greater than numbers of carousel-item those you are creating (" + r + ")", u += "\n\n", u += "Please make sure the value of (data-" + d + ") should be <= to numbers of carousel-item (" + r + ").", u += "\n\n", u += "Note : The values should not be 0 or empty And also (Positive Integers only)", alert(u), e("#" + t).css({
                            display: "none"
                        })
                    }
                }
                v(i, n, "(min-width: 1201px)", "column"), v(l, o, "(min-width: 993px) and (max-width: 1200px)", "m1200"), v(c, d, "(min-width: 769px) and (max-width: 992px)", "m992"), v(u, p, "(min-width: 577px) and (max-width: 768px)", "m768"), v(f, h, "(max-width: 576px)", "m576")
            }
            t = jQuery.fn.addClass, jQuery.fn.addClass = function () {
                var e = t.apply(this, arguments);
                return jQuery(this).trigger("slideIsChanging"), e
            }, s(), e(window).resize((function () {
                clearTimeout(a.id), a.id = setTimeout(s, 100)
            }))
        }
    })), e(".pauseVideo").on("slide.bs.carousel", (function () {
        e("video").each((function () {
            this.pause()
        }))
    })), e(".pauseVideoM").on("hide.bs.modal", (function () {
        e("video").each((function () {
            this.pause()
        }))
    })), e(".onlinePauseVideo").on("slide.bs.carousel", (function (t) {
        e(t.target).find("iframe").each((function (t, a) {
            e(a).attr("src", e(a).attr("src"))
        }))
    })), e(".onlinePauseVideoM").on("hide.bs.modal", (function (t) {
        e(t.target).find("iframe").each((function (t, a) {
            e(a).attr("src", e(a).attr("src"))
        }))
    }))
    ...
    var t = $(e.relatedTarget).index(),
        a = $(".carousel-item").length;
    if (t >= a - 3)
        for (var i = 4 - (a - t), s = 0; s < i; s++) "left" == e.direction ? $(".carousel-item").eq(s).appendTo(".carousel-inner") : $(".carousel-item").eq(0).appendTo(".carousel-inner")
}));
...
function (e, t) {
        ...
        if (i)
            if ("string" == typeof i) {
                ...
                if (0 <= d.indexOf("<") && 0 <= d.indexOf(">")) {
                    var c = "div";
                    for (0 === d.indexOf("<li") && (c = "ul"), 0 === d.indexOf("<tr") && (c = "tbody"), 0 !== d.indexOf("<td") && 0 !== d.indexOf("<th") || (c = "tr"), 0 === d.indexOf("<tbody") && (c = "table"), 0 === d.indexOf("<option") && (c = "select"), (l = e.createElement(c)).innerHTML = d, n = 0; n < l.childNodes.length; n += 1) r.push(l.childNodes[n])
                } else
    ...
    var r = {
        ...
        on: function () {
            ...
            for (var c, p = s.split(" "), u = 0; u < this.length; u += 1) {
                var h = this[u];
                if (r)
                ...
                for (var d = o[l], c = 0; c < this.length; c += 1) {
                    ...
                    if (!s && p.dom7Listeners ? u = p.dom7Listeners[d] : s && p.dom7LiveListeners && (u = p.dom7LiveListeners[d]), u && u.length)
                        for (var h = u.length - 1; 0 <= h; h -= 1) {
                            var f = u[h];
                            r && f.listener === r ? (p.removeEventListener(d, f.proxyListener, n), u.splice(h, 1)) : r || (p.removeEventListener(d, f.proxyListener, n), u.splice(h, 1))
                        }
                }
            return this
        },
                ...
                for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
                    ...
                    if (null != s)
                        for (var r = Object.keys(Object(s)), n = 0, o = r.length; n < o; n += 1) {
                            ...
                            void 0 !== c && c.enumerable && (d.isObject(a[l]) && d.isObject(s[l]) ? d.extend(a[l], s[l]) : !d.isObject(a[l]) && d.isObject(s[l]) ? (a[l] = {}, d.extend(a[l], s[l])) : a[l] = s[l])
                        }
                }
                return a
            }
    ...
    }, p.prototype.once = function (e, t, a) {
        var i = this;
    ...
    var h = {
            ...
            updateSlides: function () {
                ...
                if (void 0 !== s) {
                    var S, C;
                    "string" == typeof y && 0 <= y.indexOf("%") && (y = parseFloat(y.replace("%", "")) / 100 * s), e.virtualSize = -y, r ? p.css({
                        marginLeft: "",
                        marginTop: ""
                    }) : p.css({
                        marginRight: "",
                    ...
                    for (var M, k = a.slidesPerColumn, z = S / k, P = z - (a.slidesPerColumn * z - u), $ = 0; $ < u; $ += 1) {
                        C = 0;
                        var L = p.eq($);
                        if (1 < a.slidesPerColumn) {
                            var I = void 0,
                                D = void 0,
                                O = void 0;
                            "column" === a.slidesPerColumnFill ? (O = $ - (D = Math.floor($ / k)) * k, (P < D || D === P && O === k - 1) && k <= (O += 1) && (O = 0, D += 1), I = D + O * S / k, L.css({
                                "-webkit-box-ordinal-group": I,
                                "-moz-box-ordinal-group": I,
                                "-ms-flex-order": I,
                                "-webkit-order": I,
                                order: I
                            })) : D = $ - (O = Math.floor($ / z)) * z, L.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== O && a.spaceBetween && a.spaceBetween + "px").attr("data-swiper-column", D).attr("data-swiper-row", O)
                        }
                        if ("none" !== L.css("display")) {
                            ...
                            } else C = (s - (a.slidesPerView - 1) * y) / a.slidesPerView, a.roundLengths && (C = Math.floor(C)), p[$] && (e.isHorizontal() ? p[$].style.width = C + "px" : p[$].style.height = C + "px");
                            p[$] && (p[$].swiperSlideSize = C), v.push(C), a.centeredSlides ? (x = x + C / 2 + T / 2 + y, 0 === T && 0 !== $ && (x = x - s / 2 - y), 0 === $ && (x = x - s / 2 - y), Math.abs(x) < .001 && (x = 0), a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), f.push(x)) : (a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), f.push(x), x = x + C + y), e.virtualSize += C + y, T = C, E += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, s) + g, r && n && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                        ...
                        for (var G = 0; G < h.length; G += 1) {
                            var X = h[G];
                            a.roundLengths && (X = Math.floor(X)), h[G] < e.virtualSize + h[0] && M.push(X)
                        }
                        h = M
                    }
                    if (!a.centeredSlides) {
                        ...
                        for (var B = 0; B < h.length; B += 1) {
                            var Y = h[B];
                            a.roundLengths && (Y = Math.floor(Y)), h[B] <= e.virtualSize - s && M.push(Y)
                        }
                        h = M, 1 < Math.floor(e.virtualSize - s) - Math.floor(h[h.length - 1]) && h.push(e.virtualSize - s)
                    }
                    0 === h.length && (h = [0]), 0 !== a.spaceBetween && (e.isHorizontal() ? r ? p.css({
                        marginLeft: y + "px"
                    }) : p.css({
                        marginRight: y + "px"
                    }) : p.css({
                        ...
                        slidesGrid: f,
                        slidesSizesGrid: v
                    }), u !== l && e.emit("slidesLengthChange"), h.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== w && e.emit("slidesGridLengthChange"), (a.watchSlidesProgress || a.watchSlidesVisibility) && e.updateSlidesOffset()
                }
            },
                ...
                if (0 !== i.length) {
                    ...
                    for (var n = 0; n < i.length; n += 1) {
                        ...
                        if (a.watchSlidesVisibility) {
                            ...
                            (0 <= d && d < t.size || 0 < c && c <= t.size || d <= 0 && c >= t.size) && i.eq(n).addClass(a.slideVisibleClass)
                        }
                        o.progress = s ? -l : l
                    }
                }
        ...
        v = {
            slideTo: function (e, t, a, i) {
                ...
                return f = p < r ? "next" : r < p ? "prev" : "reset", u && -v === s.translate || !u && v === s.translate ? (s.updateActiveIndex(r), n.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== n.effect && s.setTranslate(v), "reset" !== f && (s.transitionStart(a, f), s.transitionEnd(a, f)), !1) : (0 !== t && c.transition ? (s.setTransition(t), s.setTranslate(v), s.updateActiveIndex(r), s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, i), s.transitionStart(a, f), s.animating || (s.animating = !0, s.onSlideToWrapperTransitionEnd || (s.onSlideToWrapperTransitionEnd = function (e) {
                    s && !s.destroyed && e.target === this && (s.$wrapperEl[0].removeEventListener("transitionend", s.onSlideToWrapperTransitionEnd), s.$wrapperEl[0].removeEventListener("webkitTransitionEnd", s.onSlideToWrapperTransitionEnd), s.onSlideToWrapperTransitionEnd = null, delete s.onSlideToWrapperTransitionEnd, s.transitionEnd(a, f))
            ...
            slidePrev: function (e, t, a) {
                ...
                var c, p = d(l ? i.translate : -i.translate),
                    u = n.map((function (e) {
                        return d(e)
                    })),
                    h = (o.map((function (e) {
                        return d(e)
                    })), n[u.indexOf(p)], n[u.indexOf(p) - 1]);
        ...
        m = {
            loopCreate: function () {
                ...
                r.each((function (e, a) {
                    var s = i(a);
                    e < t.loopedSlides && c.push(a), e < r.length && e >= r.length - t.loopedSlides && d.push(a), s.attr("data-swiper-slide-index", e)
                }));
                for (var p = 0; p < c.length; p += 1) s.append(i(c[p].cloneNode(!0)).addClass(a.slideDuplicateClass));
            ...
            loopFix: function () {
                ...
                i < r ? (e = s.length - 3 * r + i, e += r, t.slideTo(e, 0, !1, !0) && 0 !== c && t.setTranslate((d ? -t.translate : t.translate) - c)) : ("auto" === a.slidesPerView && 2 * r <= i || i >= s.length - r) && (e = -s.length + i + r, e += r, t.slideTo(e, 0, !1, !0) && 0 !== c && t.setTranslate((d ? -t.translate : t.translate) - c)), t.allowSlidePrev = n, t.allowSlideNext = o
            },
    ...
    var x, T = {
            attachEvents: function () {
                ...
                a.onTouchStart = function (a) {
                        ...
                        if (l.originalEvent && (l = l.originalEvent), r.isTouchEvent = "touchstart" === l.type, (r.isTouchEvent || !("which" in l) || 3 !== l.which) && (!r.isTouched || !r.isMoved))
                            ...
                            if (!u || !(c <= h || c >= t.screen.width - h)) {
                                if (d.extend(r, {
                                        ...
                                        isScrolling: void 0,
                                        startMoving: void 0
                                    }), o.startX = c, o.startY = p, r.touchStartTime = d.now(), s.allowClick = !0, s.updateSize(), s.swipeDirection = void 0, 0 < n.threshold && (r.allowThresholdMove = !1), "touchstart" !== l.type) {
                                    var f = !0;
                                    i(l.target).is(r.formElements) && (f = !1), e.activeElement && i(e.activeElement).is(r.formElements) && e.activeElement !== l.target && e.activeElement.blur(), f && s.allowTouchMove && l.preventDefault()
                                }
                                s.emit("touchStart", l)
                            }
                        }
                        ...
                        if (!s.isTouchEvent || "mousemove" !== l.type) {
                            ...
                            if (s.allowTouchCallbacks && a.emit("touchMove", l), !(l.targetTouches && 1 < l.targetTouches.length)) {
                                ...
                                if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)) < a.params.threshold))
                                    if (void 0 === s.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? s.isScrolling = !1 : 25 <= h * h + f * f && (u = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI, s.isScrolling = a.isHorizontal() ? u > r.touchAngle : 90 - u > r.touchAngle)), s.isScrolling && a.emit("touchMoveOpposite", l), void 0 === s.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (s.startMoving = !0)), s.isScrolling) s.isTouched = !1;
                                    ...
                                    n.diff = v, v *= r.touchRatio, o && (v = -v), a.swipeDirection = 0 < v ? "prev" : "next", s.currentTranslate = v + s.startTranslate;
                                    var m = !0,
                                        g = r.resistanceRatio;
                                    if (r.touchReleaseOnEdges && (g = 0), 0 < v && s.currentTranslate > a.minTranslate() ? (m = !1, r.resistance && (s.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + s.startTranslate + v, g))) : v < 0 && s.currentTranslate < a.maxTranslate() && (m = !1, r.resistance && (s.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - s.startTranslate - v, g))), m && (l.preventedByNestedSwiper = !0), !a.allowSlideNext && "next" === a.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !a.allowSlidePrev && "prev" === a.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), 0 < r.threshold) {
                    ...
                    if (t.allowClick && (t.updateClickedSlide(c), t.emit("tap", c), h < 300 && 300 < u - a.lastClickTime && (a.clickTimeout && clearTimeout(a.clickTimeout), a.clickTimeout = d.nextTick((function () {
                            t && !t.destroyed && t.emit("click", c)
                        }), 300)), h < 300 && u - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit("doubleTap", c))), a.lastClickTime = d.now(), d.nextTick((function () {
                    ...
                    if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, i.freeMode) {
                        ...
                        if (i.freeModeMomentum) {
                            if (1 < a.velocities.length) {
                                var f = a.velocities.pop(),
                                    ...
                                    g = f.time - v.time;
                                t.velocity = m / g, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (150 < g || 300 < d.now() - f.time) && (t.velocity = 0)
                            } else t.velocity = 0;
                        ...
                        for (var k = 0, z = t.slidesSizesGrid[0], P = 0; P < o.length; P += i.slidesPerGroup) void 0 !== o[P + i.slidesPerGroup] ? p >= o[P] && p < o[P + i.slidesPerGroup] && (z = o[(k = P) + i.slidesPerGroup] - o[P]) : p >= o[P] && (k = P, z = o[o.length - 1] - o[o.length - 2]);
                        var $ = (p - o[k]) / z;
                        if (h > i.longSwipesMs) {
                ...
                if (c.touch || !c.pointerEvents && !c.prefixedPointerEvents) {
                    if (c.touch) {
                        ...
                        l.addEventListener(r.start, a.onTouchStart, u), l.addEventListener(r.move, a.onTouchMove, c.passiveListener ? {
                            passive: !1,
                            capture: p
                        } : p), l.addEventListener(r.end, a.onTouchEnd, u)
                    }(s.simulateTouch && !w.ios && !w.android || s.simulateTouch && !c.touch && w.ios) && (l.addEventListener("mousedown", a.onTouchStart, !1), e.addEventListener("mousemove", a.onTouchMove, p), e.addEventListener("mouseup", a.onTouchEnd, !1))
                } else l.addEventListener(r.start, a.onTouchStart, !1), e.addEventListener(r.move, a.onTouchMove, p), e.addEventListener(r.end, a.onTouchEnd, !1);
            ...
            detachEvents: function () {
                ...
                if (c.touch || !c.pointerEvents && !c.prefixedPointerEvents) {
                    ...
                    }(a.simulateTouch && !w.ios && !w.android || a.simulateTouch && !c.touch && w.ios) && (n.removeEventListener("mousedown", t.onTouchStart, !1), e.removeEventListener("mousemove", t.onTouchMove, o), e.removeEventListener("mouseup", t.onTouchEnd, !1))
            ...
            classes: {
                addClasses: function () {
                    var e = this.classNames,
                        ...
                        i = this.$el,
                        s = [];
                    s.push(t.direction), t.freeMode && s.push("free-mode"), c.flexbox || s.push("no-flexbox"), t.autoHeight && s.push("autoheight"), a && s.push("rtl"), 1 < t.slidesPerColumn && s.push("multirow"), w.android && s.push("android"), w.ios && s.push("ios"), S.isIE && (c.pointerEvents || c.prefixedPointerEvents) && s.push("wp8-" + t.direction), s.forEach((function (a) {
        ...
        z = function (e) {
            function t() {
                ...
                var p = d.extend({}, C);
                l.useModulesParams(p), l.params = d.extend({}, p, k, r), l.originalParams = d.extend({}, l.params), l.passedParams = d.extend({}, r);
            ...
            return ((t.prototype = Object.create(e && e.prototype)).constructor = t).prototype.slidesPerViewDynamic = function () {
                ...
                if (t.centeredSlides) {
                    ...
                    for (var c = r - 1; 0 <= c; c -= 1) a[c] && !o && (n += 1, s < (l += a[c].swiperSlideSize) && (o = !0))
                } else
        ...
        A = {
            update: function (e) {
                ...
                f = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", r ? (v = Math.floor(i / 2) + s, m = Math.floor(i / 2) + s) : (v = i + (s - 1), m = s);
                ...
                if (d.extend(t.virtual, {
                    ...
                    }), o === b && l === w && !e) return t.slidesGrid !== p && y !== h && t.slides.css(f, y + "px"), void t.updateProgress();
                ...
                for (var C = 0; C < c.length; C += 1) b <= C && C <= w && (void 0 === l || e ? E.push(C) : (l < C && E.push(C), C < o && T.push(C)));
        ...
        X = {
            ...
            enable: function () {
                ...
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.on("mouseenter", e.mousewheel.handleMouseEnter), t.on("mouseleave", e.mousewheel.handleMouseLeave), t.on(X.event, e.mousewheel.handle), e.mousewheel.enabled = !0
            },
            disable: function () {
                var e = this;
                if (!X.event) return !1;
                if (!e.mousewheel.enabled) return !1;
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.off(X.event, e.mousewheel.handle), !(e.mousewheel.enabled = !1)
            }
        },
        B = {
            update: function () {
            ...
            update: function () {
                ...
                if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (e.params.loop ? ((s = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > r - 1 - 2 * e.loopedSlides && (s -= r - 2 * e.loopedSlides), o - 1 < s && (s -= o), s < 0 && "bullets" !== e.params.paginationType && (s = o + s)) : s = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === a.type && e.pagination.bullets && 0 < e.pagination.bullets.length) {
                        ...
                        if (a.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), n.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (a.dynamicMainBullets + 4) + "px"), 1 < a.dynamicMainBullets && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += s - e.previousIndex, e.pagination.dynamicBulletIndex > a.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = a.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), l = s - e.pagination.dynamicBulletIndex, c = ((d = l + (Math.min(p.length, a.dynamicMainBullets) - 1)) + l) / 2), p.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev " + a.bulletActiveClass + "-main"), 1 < n.length) p.each((function (e, t) {
                            var r = i(t),
                                n = r.index();
                            ...
                            for (var u = p.eq(l), h = p.eq(d), f = l; f <= d; f += 1) p.eq(f).addClass(a.bulletActiveClass + "-main");
                        ...
                        if (a.dynamicBullets) {
                            var v = Math.min(p.length, a.dynamicMainBullets + 4),
                                ...
                                g = t ? "right" : "left";
                            p.css(e.isHorizontal() ? g : "top", m + "px")
                        }
                    }
        ...
        V = {
            ...
            disableDraggable: function () {
                ...
                if (t.params.scrollbar.el) {
                    ...
                    c.touch || !c.pointerEvents && !c.prefixedPointerEvents ? (c.touch && (n.removeEventListener(i.start, t.scrollbar.onDragStart, o), n.removeEventListener(i.move, t.scrollbar.onDragMove, o), n.removeEventListener(i.end, t.scrollbar.onDragEnd, l)), (r.simulateTouch && !w.ios && !w.android || r.simulateTouch && !c.touch && w.ios) && (n.removeEventListener("mousedown", t.scrollbar.onDragStart, o), e.removeEventListener("mousemove", t.scrollbar.onDragMove, o), e.removeEventListener("mouseup", t.scrollbar.onDragEnd, l))) : (n.removeEventListener(s.start, t.scrollbar.onDragStart, o), e.removeEventListener(s.move, t.scrollbar.onDragMove, o), e.removeEventListener(s.end, t.scrollbar.onDragEnd, l))
                }
            },
            init: function () {
                var e = this;
        ...
        R = {
            setTransform: function (e, t) {
                ...
                if (o || l ? (o = o || "0", l = l || "0") : this.isHorizontal() ? (o = n, l = "0") : (l = n, o = "0"), o = 0 <= o.indexOf("%") ? parseInt(o, 10) * t * r + "%" : o * t * r + "px", l = 0 <= l.indexOf("%") ? parseInt(l, 10) * t + "%" : l * t + "px", null != c) {
                    ...
                    !r.hasClass(s.elementClass) || r.hasClass(s.loadedClass) || r.hasClass(s.loadingClass) || (n = n.add(r[0])), 0 !== n.length && n.each((function (e, n) {
                        ...
                        a.loadImage(o[0], d || l, c, p, !1, (function () {
                            if (null != a && a && (!a || a.params) && !a.destroyed) {
                                if (l ? (o.css("background-image", 'url("' + l + '")'), o.removeAttr("data-background")) : (c && (o.attr("srcset", c), o.removeAttr("data-srcset")), p && (o.attr("sizes", p), o.removeAttr("data-sizes")), d && (o.attr("src", d), o.removeAttr("data-src"))), o.addClass(s.loadedClass).removeClass(s.loadingClass), r.find("." + s.preloaderClass).remove(), a.params.loop && t) {
            ...
            load: function () {
                ...
                if (o.loadPrevNext)
                    if (1 < l || o.loadPrevNextAmount && 1 < o.loadPrevNextAmount) {
                        for (var u = o.loadPrevNextAmount, h = l, f = Math.min(r + h + Math.max(u, h), s.length), v = Math.max(r - Math.max(h, u), 0), m = r + l; m < f; m += 1) d(m) && e.lazy.loadInSlide(m);
        ...
        q = {
            ...
            setTransition: function (e, t) {
                ...
                if (Array.isArray(s))
                    for (a = 0; a < s.length; a += 1) s[a] !== t && s[a] instanceof z && r(s[a]);
        ...
        Z = {
            setTranslate: function () {
                var e, t = this,
                    ...
                    h = 0;
                c.shadow && (p ? (0 === (e = s.find(".swiper-cube-shadow")).length && (e = i('<div class="swiper-cube-shadow"></div>'), s.append(e)), e.css({
                    height: n + "px"
                ...
                for (var f = 0; f < r.length; f += 1) {
                    ...
                    var w = Math.max(Math.min(v[0].progress, 1), -1),
                        ...
                        x = 0,
                        T = 0;
                    m % 4 == 0 ? (y = 4 * -b * d, T = 0) : (m - 1) % 4 == 0 ? (y = 0, T = 4 * -b * d) : (m - 2) % 4 == 0 ? (y = d + 4 * b * d, T = d) : (m - 3) % 4 == 0 && (y = -d, T = 3 * d + 4 * d * b), l && (y = -y), p || (x = y, y = 0);
                    var E = "rotateX(" + (p ? 0 : -g) + "deg) rotateY(" + (p ? g : 0) + "deg) translate3d(" + y + "px, " + x + "px, " + T + "px)";
                    if (w <= 1 && -1 < w && (h = 90 * m + 90 * w, l && (h = 90 * -m - 90 * w)), v.transform(E), c.slideShadows) {
                        var C = p ? v.find(".swiper-slide-shadow-left") : v.find(".swiper-slide-shadow-top"),
                            M = p ? v.find(".swiper-slide-shadow-right") : v.find(".swiper-slide-shadow-bottom");
                        0 === C.length && (C = i('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), v.append(C)), 0 === M.length && (M = i('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), v.append(M)), C.length && (C[0].style.opacity = Math.max(-w, 0)), M.length && (M[0].style.opacity = Math.max(w, 0))
                    }
                }
                if (s.css({
                    ...
                    if (p) e.transform("translate3d(0px, " + (n / 2 + c.shadowOffset) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + c.shadowScale + ")");
                    else {
            ...
            setTranslate: function () {
                for (var e = this, t = e.slides, a = e.rtlTranslate, s = 0; s < t.length; s += 1) {
                    ...
                    var o = -180 * n,
                        ...
                        c = 0;
                    if (e.isHorizontal() ? a && (o = -o) : (c = d, l = -o, o = d = 0), r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length, e.params.flipEffect.slideShadows) {
                        ...
                        0 === p.length && (p = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'), r.append(p)), 0 === u.length && (u = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'), r.append(u)), p.length && (p[0].style.opacity = Math.max(-n, 0)), u.length && (u[0].style.opacity = Math.max(n, 0))
                    }
        ...
        ee = {
            setTranslate: function () {
                for (var e = this, t = e.width, a = e.height, s = e.slides, r = e.$wrapperEl, n = e.slidesSizesGrid, o = e.params.coverflowEffect, l = e.isHorizontal(), d = e.translate, p = l ? t / 2 - d : a / 2 - d, u = l ? o.rotate : -o.rotate, h = o.depth, f = 0, v = s.length; f < v; f += 1) {
                    var m = s.eq(f),
                        g = n[f],
    ...
    return void 0 === z.use && (z.use = z.Class.use, z.installModule = z.Class.installModule), z.use(te), z
}));
